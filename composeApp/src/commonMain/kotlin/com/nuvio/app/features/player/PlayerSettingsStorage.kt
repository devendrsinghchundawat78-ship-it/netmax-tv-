...
internal expect object PlayerSettingsStorage {
    ...
    fun loadVisualEnhancerEnabled(): Boolean?
    fun saveVisualEnhancerEnabled(enabled: Boolean)
    fun loadVisualEnhancerMode(): String?
    fun saveVisualEnhancerMode(mode: String)
