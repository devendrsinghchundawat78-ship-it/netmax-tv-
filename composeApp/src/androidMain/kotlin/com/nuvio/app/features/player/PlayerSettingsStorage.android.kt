...
actual object PlayerSettingsStorage {
    ...
    private const val visualEnhancerEnabledKey = "visual_enhancer_enabled"
    private const val visualEnhancerModeKey = "visual_enhancer_mode"
    private val syncKeys = listOf(
        ...
        iosSaturationKey,
        iosGammaKey,
        visualEnhancerEnabledKey,
        visualEnhancerModeKey,
    )
    ...
    actual fun exportToSyncPayload(): JsonObject = buildJsonObject {
        ...
        loadVisualEnhancerEnabled()?.let { put(visualEnhancerEnabledKey, encodeSyncBoolean(it)) }
        loadVisualEnhancerMode()?.let { put(visualEnhancerModeKey, encodeSyncString(it)) }
    }
    ...
    actual fun replaceFromSyncPayload(payload: JsonObject) {
        ...
        payload.decodeSyncBoolean(visualEnhancerEnabledKey)?.let(::saveVisualEnhancerEnabled)
        payload.decodeSyncString(visualEnhancerModeKey)?.let(::saveVisualEnhancerMode)
    }
}
